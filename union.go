...
// NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_E_OpenconfigAft_LabelEntry_PoppedMplsLabelStack is used when /openconfig-network-instance/network-instances/network-instance/afts/mpls/label-entry/state/popped-mpls-label-stack
// is to be set to a E_OpenconfigAft_LabelEntry_PoppedMplsLabelStack value.
...
// Is_NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union ensures that NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_E_OpenconfigAft_LabelEntry_PoppedMplsLabelStack
...
// NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_Uint32 is used when /openconfig-network-instance/network-instances/network-instance/afts/mpls/label-entry/state/popped-mpls-label-stack
// is to be set to a uint32 value.
type NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_Uint32 struct {
	Uint32 uint32
}

// Is_NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union ensures that NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_Uint32
// implements the NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union interface.
...
func (t *NetworkInstance_Afts_LabelEntry) To_NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union(i interface{}) (NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigAft_LabelEntry_PoppedMplsLabelStack:
		return &NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_E_OpenconfigAft_LabelEntry_PoppedMplsLabelStack{v}, nil
	case uint32:
		return &NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Afts_LabelEntry_PoppedMplsLabelStack_Union, unknown union type, got: %T, want any of [E_OpenconfigAft_LabelEntry_PoppedMplsLabelStack, uint32]", i, i)
	}
}
...
// NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_E_OpenconfigAft_NextHop_PushedMplsLabelStack is used when /openconfig-network-instance/network-instances/network-instance/afts/next-hops/next-hop/state/pushed-mpls-label-stack
...
// Is_NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union ensures that NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_E_OpenconfigAft_NextHop_PushedMplsLabelStack
...
// NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_Uint32 is used when /openconfig-network-instance/network-instances/network-instance/afts/next-hops/next-hop/state/pushed-mpls-label-stack
// is to be set to a uint32 value.
type NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_Uint32 struct {
	Uint32 uint32
}

// Is_NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union ensures that NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_Uint32
// implements the NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union interface.
...
func (t *NetworkInstance_Afts_NextHop) To_NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union(i interface{}) (NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union, error) {
	...
	case E_OpenconfigAft_NextHop_PushedMplsLabelStack:
		return &NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_E_OpenconfigAft_NextHop_PushedMplsLabelStack{v}, nil
	case uint32:
		return &NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Afts_NextHop_PushedMplsLabelStack_Union, unknown union type, got: %T, want any of [E_OpenconfigAft_NextHop_PushedMplsLabelStack, uint32]", i, i)
	}
}
...
// NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union_E_OpenconfigMpls_Ingress_IncomingLabel is used when /openconfig-network-instance/network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/ingress/config/incoming-label
// is to be set to a E_OpenconfigMpls_Ingress_IncomingLabel value.
...
// Is_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union ensures that NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union_E_OpenconfigMpls_Ingress_IncomingLabel
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Ingress) To_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigMpls_Ingress_IncomingLabel:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union_E_OpenconfigMpls_Ingress_IncomingLabel{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigMpls_Ingress_IncomingLabel, uint32]", i, i)
	}
}
...
// NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union_E_OpenconfigMpls_Ingress_PushLabel is used when /openconfig-network-instance/network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/ingress/config/push-label
// is to be set to a E_OpenconfigMpls_Ingress_PushLabel value.
...
// Is_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union ensures that NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union_E_OpenconfigMpls_Ingress_PushLabel
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Ingress) To_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigMpls_Ingress_PushLabel:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union_E_OpenconfigMpls_Ingress_PushLabel{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigMpls_Ingress_PushLabel, uint32]", i, i)
	}
}
...
// NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union_E_OpenconfigMpls_Transit_IncomingLabel is used when /openconfig-network-instance/network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/transit/config/incoming-label
// is to be set to a E_OpenconfigMpls_Transit_IncomingLabel value.
...
// Is_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union ensures that NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union_E_OpenconfigMpls_Transit_IncomingLabel
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Transit) To_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigMpls_Transit_IncomingLabel:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union_E_OpenconfigMpls_Transit_IncomingLabel{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigMpls_Transit_IncomingLabel, uint32]", i, i)
	}
}
...
// NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union_E_OpenconfigMpls_Transit_PushLabel is used when /openconfig-network-instance/network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/transit/config/push-label
// is to be set to a E_OpenconfigMpls_Transit_PushLabel value.
...
// Is_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union ensures that NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union_E_OpenconfigMpls_Transit_PushLabel
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Transit) To_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigMpls_Transit_PushLabel:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union_E_OpenconfigMpls_Transit_PushLabel{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union, unknown union type, got: %T, want any of [E_OpenconfigMpls_Transit_PushLabel, uint32]", i, i)
	}
}
...
// is to be set to a E_OpenconfigMplsRsvp_ExplicitRouteObject_Label value.
...
// Is_NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union ensures that NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union_E_OpenconfigMplsRsvp_ExplicitRouteObject_Label
...
// NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union_Uint32 is used when /openconfig-network-instance/network-instances/network-instance/mpls/signaling-protocols/rsvp-te/sessions/session/explicit-route-objects/explicit-route-object/state/label
// is to be set to a uint32 value.
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union_Uint32 struct {
	Uint32 uint32
}

// Is_NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union ensures that NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union_Uint32
// implements the NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union interface.
...
func (t *NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject) To_NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union(i interface{}) (NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union, error) {
	switch v := i.(type) {
	case E_OpenconfigMplsRsvp_ExplicitRouteObject_Label:
		return &NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union_E_OpenconfigMplsRsvp_ExplicitRouteObject_Label{v}, nil
	case uint32:
		return &NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Session_ExplicitRouteObject_Label_Union, unknown union type, got: %T, want any of [E_OpenconfigMplsRsvp_ExplicitRouteObject_Label, uint32]", i, i)
	}
}
