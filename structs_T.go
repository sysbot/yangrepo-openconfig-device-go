...
type TerminalDevice_Channel_Assignment struct {
	...
	Mapping             E_OpenconfigTransportTypes_FRAME_MAPPING_PROTOCOL    `path:"config/mapping" module:"openconfig-terminal-device"`
	...
	TributarySlotIndex  *int32                                               `path:"config/tributary-slot-index" module:"openconfig-terminal-device"`
...
type TerminalDevice_Channel_Ethernet struct {
	...
	InBlockErrors                *uint64           `path:"state/in-block-errors" module:"openconfig-terminal-device"`
	...
	InPcsBipErrors               *uint64           `path:"state/in-pcs-bip-errors" module:"openconfig-terminal-device"`
	ΛInPcsBipErrors              []ygot.Annotation `path:"state/@in-pcs-bip-errors" ygotAnnotation:"true"`
	InPcsErroredSeconds          *uint64           `path:"state/in-pcs-errored-seconds" module:"openconfig-terminal-device"`
	ΛInPcsErroredSeconds         []ygot.Annotation `path:"state/@in-pcs-errored-seconds" ygotAnnotation:"true"`
	InPcsSeverelyErroredSeconds  *uint64           `path:"state/in-pcs-severely-errored-seconds" module:"openconfig-terminal-device"`
	ΛInPcsSeverelyErroredSeconds []ygot.Annotation `path:"state/@in-pcs-severely-errored-seconds" ygotAnnotation:"true"`
	InPcsUnavailableSeconds      *uint64           `path:"state/in-pcs-unavailable-seconds" module:"openconfig-terminal-device"`
	...
	OutBlockErrors               *uint64           `path:"state/out-block-errors" module:"openconfig-terminal-device"`
	ΛOutBlockErrors              []ygot.Annotation `path:"state/@out-block-errors" ygotAnnotation:"true"`
	OutCrcErrors                 *uint64           `path:"state/out-crc-errors" module:"openconfig-terminal-device"`
	...
	OutPcsBipErrors              *uint64           `path:"state/out-pcs-bip-errors" module:"openconfig-terminal-device"`
...
type TerminalDevice_Channel_Otn struct {
	...
	TributarySlotGranularity  E_OpenconfigTransportTypes_TRIBUTARY_SLOT_GRANULARITY `path:"config/tributary-slot-granularity" module:"openconfig-terminal-device"`
